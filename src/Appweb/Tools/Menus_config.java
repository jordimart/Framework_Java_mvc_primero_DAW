...
public class Menus_config {
    ...
    public static Object menucomboboxl(String titulo, String mensaje) {
        ...
        String[] combo = {"english", "espa�ol", "valencia"};
                ...
                case 3:// Language//
                    ...
                    switch (set) {
                        ...
                        case "english":
                            ...
                            break;
                        case "espa�ol":
                            Classconfig.getInstance().setLanguage("espa�ol");
     ...
     *
     * Open last settings. Open files of users. Question to start with dummies
     * or not. If dummy is press tehe dummy configuration will be save true.
     */
     ...
     *
     * Question to save or not save settings configuration. Question to save
     * users modification or no. Exit the aplication.
     */
