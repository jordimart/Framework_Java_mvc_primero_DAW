...
public class Menu {
	...
	/**
	 * Menu de inicio de aplicacion.Podemos elegir entre probar la
	 * aplicacion,entrar a configuracion,Utilizar Dummies,Informacion de la
	 * aplicacion o salir.
	 * 
	 * @param titulo
	 * @param mensaje
	 * @return int
	 */
	public static int menu_start(String titulo, String mensaje) {

		int opcion = 0;

		String[] menu = { Lang.getInstance().getProperty("Test"), Lang.getInstance().getProperty("Configure"), "Dummy",
				Lang.getInstance().getProperty("Information"), Lang.getInstance().getProperty("Exit") };

		opcion = JOptionPane.showOptionDialog(null, Lang.getInstance().getProperty("What_would_you_like_to_do?"),
				Lang.getInstance().getProperty("Welcome_to_JMFApp"), 0, JOptionPane.QUESTION_MESSAGE, null, menu, menu[0]);
		// if (opcion == -1)
		// JOptionPane.showMessageDialog(null,
		// Lang.getInstance().getProperty("Completed_aplication"),
		// Lang.getInstance().getProperty("I_to_exit_aplication"),
	...
	/**
	 * Menu para elegir si trabajar con usuarios o productos.
	 * 
	 * @param titulo
	 * @param mensaje
	 * @return int
	 */
	public static int menu_object_type(String titulo, String mensaje) {

		int opcion = 0;

		String[] menu = { Lang.getInstance().getProperty("Users"), Lang.getInstance().getProperty("Products"),
				Lang.getInstance().getProperty("Back") };

		opcion = JOptionPane.showOptionDialog(null, Lang.getInstance().getProperty("In_which_section_do_you_want_to_work?"),
				Lang.getInstance().getProperty("Sections"), 0, JOptionPane.QUESTION_MESSAGE, null, menu, menu[0]);
		// if (opcion == -1)
		// JOptionPane.showMessageDialog(null,
		// Lang.getInstance().getProperty("Completed_aplication"),Lang.getInstance().getProperty("I_to_exit_aplication"),
		// JOptionPane.INFORMATION_MESSAGE);
