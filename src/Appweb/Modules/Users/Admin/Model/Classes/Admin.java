...
public class Admin extends User implements Serializable {
     ...
     * Lang.getInstance().getProperty("Recruitment_date") + ": " +
     * this.getDate_cont().todate() + "\n");
     * buffer.append(Lang.getInstance().getProperty("Antique") + ": " +
     * this.getAntique() + "\n");
     * buffer.append(this.toSalary());
     * buffer.append(Lang.getInstance().getProperty("Activity") + ": " +
     * this.getActivity() + "\n");
     *
