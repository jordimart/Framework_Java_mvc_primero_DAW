...
public class json {
	...
	public static void auto_save_json_file_dummy() {
		...
		try {
			...
			System.out.print(Lang.getInstance().getProperty("Error_loading_user_file")+ "json dummy Admin"+" \n");
		}
	...
	public static void auto_open_json_file_dummy() {
		...
		try {
			PATH = new java.io.File(".").getCanonicalPath() + "/src/Appweb/Modules/Users/model/Files/Admin_files/dummyadminusers.json";
		} catch (IOException e) {
			e.printStackTrace();
		}
