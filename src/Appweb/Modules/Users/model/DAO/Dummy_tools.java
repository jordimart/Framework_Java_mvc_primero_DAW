...
public class Dummy_tools {
	...
	/**
	 * Funcion que devuelve una fecha que debe cumplir que los a�os sean igual o
	...
	public static ClassDate Dummydate_int_min(int min) {
		...
		do {
			...
			// JOptionPane.showMessageDialog(null, "A�os: " + years);
		} while (years < min);
	...
	public static Admin Dummyadmin() {
		...
		date_cont = Dummy_tools.Dummy_date_entry(Date_birth, 16);
	...
	public static Client DummyClient() {
		...
		// Enter Admin attributes
		entry_date = Dummy_tools.Dummy_date_entry(Date_birth, 18);
